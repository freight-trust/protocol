...
namespace FreightTrust.EDI.X12004010
{
    ...
    public class Loop_HL_856
    {
        ...
        [ListCount(100)]
        [Pos(18)]
        public List<Loop_LH1_856> LH1Loop { get; set; }
        /// <summary>
        /// Loop for Load Detail
        /// </summary>
        [DataMember]
        [ListCount(200)]
        [Pos(19)]
        public List<Loop_CLD_856> CLDLoop { get; set; }
        /// <summary>
        /// Marks and Numbers
        /// </summary>
        [DataMember]
        ...
        [ListCount(200)]
        [Pos(24)]
        public List<Loop_N1_856> N1Loop { get; set; }
        /// <summary>
        ...
        [DataMember]
        [Pos(28)]
        public List<Loop_SAC_856> SACLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(31)]
        public List<Loop_LM_856> LMLoop { get; set; }
        /// <summary>
        /// Loop for Vessel Identification
        /// </summary>
        [DataMember]
        [Pos(32)]
        public List<Loop_V1_856> V1Loop { get; set; }
    }
    ...
    public class TS856 : EdiMessage
    {
        ...
        [ListCount(200000)]
        [Pos(4)]
        public List<Loop_HL_856> HLLoop { get; set; }
        /// <summary>
        /// Transaction Totals
        /// </summary>
        [DataMember]
