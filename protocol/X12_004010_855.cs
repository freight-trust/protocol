...
namespace FreightTrust.EDI.X12004010
{
    ...
    public class Loop_PO1_855
    {
        ...
        [ListCount(1000)]
        [Pos(9)]
        public List<Loop_PID_855> PIDLoop { get; set; }
        /// <summary>
        /// Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(14)]
        public List<Loop_SAC_855> SACLoop { get; set; }
        /// <summary>
        /// Conditions of Sale
        /// </summary>
        [DataMember]
        ...
        [ListCount(104)]
        [Pos(29)]
        public List<Loop_ACK_855> ACKLoop { get; set; }
        /// <summary>
        /// Marks and Numbers
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(34)]
        public List<Loop_QTY_855> QTYLoop { get; set; }
        /// <summary>
        /// Loop for Marking, Packaging, Loading
        /// </summary>
        [DataMember]
        [ListCount(200)]
        [Pos(35)]
        public List<Loop_PKG_855> PKGLoop { get; set; }
        /// <summary>
        ...
        [ListCount(200)]
        [Pos(36)]
        public List<Loop_SCH_855> SCHLoop { get; set; }
        /// <summary>
        /// Loop for Reference Identification
        /// </summary>
        [DataMember]
        [ListCount(1000)]
        [Pos(37)]
        public List<Loop_N9_855> N9Loop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [ListCount(200)]
        [Pos(38)]
        public List<Loop_N1_855_2> N1Loop { get; set; }
        /// <summary>
        ...
        [ListCount(1000)]
        [Pos(39)]
        public List<Loop_SLN_855> SLNLoop { get; set; }
    }
    ...
    public class Loop_SLN_855
    {
        ...
        [DataMember]
        [Pos(15)]
        public List<Loop_N9_855_2> N9Loop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(16)]
        public List<Loop_N1_855_3> N1Loop { get; set; }
    }
    ...
    public class TS855 : EdiMessage
    {
        ...
        [ListCount(200)]
        [Pos(31)]
        public List<Loop_N1_855> N1Loop { get; set; }
        /// <summary>
        /// Loop for Advertising Demographic Information
        /// </summary>
        [DataMember]
        [Pos(32)]
        public List<Loop_ADV_855> ADVLoop { get; set; }
        /// <summary>
        /// Loop for Baseline Item Data
        /// </summary>
        [DataMember]
        [ListCount(100000)]
        [Pos(33)]
        public List<Loop_PO1_855> PO1Loop { get; set; }
        /// <summary>
        /// Loop for Transaction Totals
        /// </summary>
        [DataMember]
        [Pos(34)]
        public Loop_CTT_855 CTTLoop { get; set; }
        /// <summary>
