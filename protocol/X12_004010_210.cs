...
namespace FreightTrust.EDI.X12004010
{
    ...
    public class Loop_LX_210
    {
        ...
        [ListCount(999999)]
        [Pos(12)]
        public List<Loop_SPO_210> SPOLoop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [ListCount(999999)]
        [Pos(13)]
        public List<Loop_N1_210_3> N1Loop { get; set; }
    }
    ...
    public class Loop_N1_210_2
    {
        ...
        [ListCount(10)]
        [Pos(6)]
        public List<Loop_N7_210> N7Loop { get; set; }
    }
    ...
    public class Loop_N1_210_3
    {
        ...
        [ListCount(999999)]
        [Pos(6)]
        public List<Loop_CD3_210> CD3Loop { get; set; }
        /// <summary>
        /// Loop for Shipment Purchase Order Detail
        /// </summary>
        [DataMember]
    ...
    public class Loop_S5_210
    {
        ...
        [ListCount(2)]
        [Pos(6)]
        public List<Loop_N1_210_2> N1Loop { get; set; }
    }
    ...
    public class TS210 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(11)]
        public List<Loop_N1_210> N1Loop { get; set; }
        /// <summary>
        /// Loop for Equipment Details
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(14)]
        public List<Loop_S5_210> S5Loop { get; set; }
        /// <summary>
        /// Loop for Assigned Number
        /// </summary>
        [DataMember]
        [ListCount(9999)]
        [Pos(15)]
        public List<Loop_LX_210> LXLoop { get; set; }
        /// <summary>
