namespace FreightTrust.EDI.X12004010
{
    ...
    public class Loop_BLI_100
    {
        ...
        [DataMember]
        [Pos(6)]
        public List<Loop_SI_100> SILoop { get; set; }
    }
    ...
    public class Loop_N1_100
    {
        ...
        [DataMember]
        [Pos(8)]
        public List<Loop_PER_100> PERLoop { get; set; }
        /// <summary>
        /// Loop for Product/Item Description
        /// </summary>
        [DataMember]
        [Pos(9)]
        public List<Loop_PID_100> PIDLoop { get; set; }
    }
    ...
    public class Loop_N4_100
    {
        ...
        [DataMember]
        [Pos(3)]
        public List<Loop_AM1_100> AM1Loop { get; set; }
        /// <summary>
        /// Loop for Baseline Item Data
        /// </summary>
        [DataMember]
        [Pos(4)]
        public List<Loop_PO1_100_2> PO1Loop { get; set; }
    }
    ...
    public class Loop_PID_100
    {
        ...
        [DataMember]
        [Pos(4)]
        public List<NM1> NM1 { get; set; }
        /// <summary>
        /// Loop for Baseline Item Data
        /// </summary>
        [DataMember]
        [Pos(5)]
        public List<Loop_BLI_100> BLILoop { get; set; }
        /// <summary>
        /// Loop for Informational Values
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(7)]
        public List<Loop_PO1_100> PO1Loop { get; set; }
        /// <summary>
        /// Loop for Geographic Location
        /// </summary>
        [DataMember]
        [Pos(8)]
        public List<Loop_N4_100> N4Loop { get; set; }
    }
    ...
    public class TS100 : EdiMessage
    {
        ...
        [Required]
        [Pos(5)]
        public List<Loop_NM1_100> NM1Loop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [Required]
        [Pos(6)]
        public List<Loop_N1_100> N1Loop { get; set; }
        /// <summary>
