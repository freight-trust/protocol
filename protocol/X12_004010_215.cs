...
namespace FreightTrust.EDI.X12004010
{
    ...
    public class Loop_AT6_215
    {
        ...
        [Required]
        [Pos(1)]
        public AT6 AT6 { get; set; }
        /// <summary>
        /// Shipment Rates and Charges
        /// </summary>
        [DataMember]
        [Pos(2)]
        public MS5 MS5 { get; set; }
        /// <summary>
        ...
        [ListCount(999999)]
        [Pos(10)]
        public List<Loop_SLN_215> SLNLoop { get; set; }
    }
    ...
    public class Loop_SMD_215
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public List<Loop_N1_215_2> N1Loop { get; set; }
        /// <summary>
        /// Loop for Carton (Package) Detail
        /// </summary>
        [DataMember]
        ...
        [ListCount(999999)]
        [Pos(10)]
        public List<Loop_CD3_215> CD3Loop { get; set; }
        /// <summary>
        /// Loop for International Manifest Information
        /// </summary>
        [DataMember]
        [ListCount(999999)]
        [Pos(11)]
        public List<Loop_AT6_215> AT6Loop { get; set; }
    }
    ...
    public class TS215 : EdiMessage
    {
        ...
        [Required]
        [Pos(7)]
        public Loop_N1_215 N1Loop { get; set; }
        /// <summary>
        /// Loop for Consolidated Shipment Manifest Data
        /// </summary>
        [DataMember]
        ...
        [ListCount(999999)]
        [Pos(8)]
        public List<Loop_SMD_215> SMDLoop { get; set; }
        /// <summary>
