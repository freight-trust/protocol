...
describe("Schema", function() {
  describe("#constructor()", function() {
    ...
    it("Should return an instance of Schema",
       function() { assert(testSchema instanceof Schema); });
    it("Should be able to get version",
       function() { assert.strictEqual(testSchema.version, "005010X221A1"); });
    it("Should be able to get schema",
       function() { assert.deepStrictEqual(testSchema.schema, schema); });
    it("Should be able to get default",
       function() { assert.strictEqual(testSchema.default, true); });
  });
